...
// Source: simple_bank/db/sqlc (interfaces: IStore)
...
func (m *MockIStore) CreateTransfers(arg0 context.Context, arg1 db.CreateTransfersParams) (db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockIStore) Transfertx(arg0 context.Context, arg1 db.TransferTxParams) (db.TransferTxResults, error) {
	m.ctrl.T.Helper()
